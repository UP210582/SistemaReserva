...
public class PaymentInfoController {
    ...
    @GetMapping("/all")
    @Operation(summary = "Obtener toda la información de pago")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Obtener información de pago por ID")
    ...
    @Operation(summary = "Obtener información de pago por ID de usuario")
    public ResponseEntity<List<PaymentInfoDTO>> getPaymentInfoByUserId(@PathVariable Long userId) {
        List<PaymentInfoDTO> paymentInfos = paymentInfoService.findByUserId(userId);
        return new ResponseEntity<>(paymentInfos, HttpStatus.OK);
    }

    @PostMapping
    @Operation(summary = "Crear nueva información de pago")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Actualizar información de pago existente")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Eliminar información de pago por ID")
